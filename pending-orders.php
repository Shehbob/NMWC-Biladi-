	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				...
				<li class='active'>سلة الطلبات </li>
			</ul>
		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="cart-description item">الصورة </th>
					<th class="cart-product-name item">اسم المنتج</th>
			
					<th class="cart-qty item">الكمية </th>
					<th class="cart-sub-total item">سعر الوحدة </th>
						<th class="cart-sub-total item">رسوم توصيل الطلب </th>
					<th class="cart-total">الاجمالي </th>
					<th class="cart-total item">عملية الشراء</th>
					<th class="cart-description item">تاريخ الطلب </th>
...
?>
				<tr>
					...
					<td><a href="pending-orders.php?id=<?php echo $row['oid']; ?> ">حذف</td>
				</tr>
<?php $cnt=$cnt+1;} ?>

<?php } else {?>
<tr>
<td colspan="10" align="center">< الا يوجد نتائج اليوم</h4></td>
</tr>
<?php } ?>
