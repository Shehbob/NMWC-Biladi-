...
<div class="side-menu animate-dropdown outer-bottom-xs">
    <div class="head"><i class="icon fa fa-align-justify fa-fw"></i>قائمة تفاصيل الطلبات </div>        
...
{?>							
	...
	<div class="product">		
	  ...
	  <?php } } else {?>
		...
		<div class="col-sm-6 col-md-4 wow fadeInUp"> <h3>لم يتم العثور على الطلبات </h3>
		</div>
