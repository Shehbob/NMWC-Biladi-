...
<li><a href="https://urbanstalls.com/sellerdetail.php"><i class="icon fa fa-sign-in"></i>&nbsp Feedback Seller</a></li> -->              </a>
     ...
     <div class="module-body m-t-20">
        <p class="about-us"> Brought To You By <a href="./">شهاب الواقدي </a></p>
...
<div class="contact-timing">
	<div class="module-heading">
		<h4 class="module-title">وقت وصول الطلب </h4>
	</div><!-- /.module-heading -->
	...
	<div class="module-body outer-top-xs">
		<div class="table-responsive">
			<table class="table">
				<tbody>
					<tr><td>السبت -الخميس :</td><td class="pull-right">08:00AM To 06:00PM</td></tr>
...
<div class="contact-information">
	<div class="module-heading">
		<h4 class="module-title">المعلومات </h4>
	</div><!-- /.module-heading -->
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="index.php">SHEHAB.COM</a></span>
                </div>
            </li>
