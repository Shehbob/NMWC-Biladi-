...
<div class="sidebar-widget outer-bottom-xs wow fadeInUp">
	<h3 class="section-title">قائمة الطلبات</h3>
...
<div class="sidebar-widget hot-deals wow fadeInUp">
	<h3 class="section-title"> حول المنتج </h3>
...
<div class="product-image">
						<div class="hot-deal-wrapper">
							<div class="image">
<a href="‏‏product-details2.php?pid=<?php echo htmlentities($row['id']);?>">
<img  src="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>" data-echo="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>"  width="210" height="250" alt=""></a>
...
<div class="stock-container info-container m-t-10">
							...
							<div class="quantity-container info-container">
								<div class="row">
									...
									<div class="col-sm-7">
										<a href="product-details.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="btn btn-primary"><i class="fa fa-shopping-cart inner-right-vs"></i>اطلب الان</a>
									</div>
			...
			<div class="product-price">	
				<span class="price">
					Rs.<?php echo htmlentities($rw['productPrice']);?>			</span>
										     <span class="price-before-discount">RY.
				...
				<div class="action">
					<ul class="list-unstyled">
						...
						<a href="product-details.php?page=product&action=add&id=<?php echo $rw['id']; ?>" class="lnk btn btn-primary">اطلب الان </a>
