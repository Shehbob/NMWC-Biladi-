...
$_SESSION['errmsg']="تم تعديل الباسوورد بنجاح ";
exit();
}
else
{
...
$uri  = rtrim(dirname($_SERVER['PHP_SELF']),'/\\');
header("location:http://$host$uri/$extra");
$_SESSION['errmsg']="ادخل الايميل او رقم الهاتف";
exit();
}
}
	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				...
				<li class='active'>نسيت كلمة المرور</li>
			</ul>
...
?>
		...
		<div class="form-group">
	  	...
	  	<div class="form-group">
		    <label class="info-title" for="exampleInputPassword1">رقم الهاتف <span>*</span></label>
...
<div class="form-group">
	    	<label class="info-title" for="confirmpassword">اعد كلمة المرور<span>*</span></label>
	    	<input type="password" class="form-control unicase-form-control text-input" id="confirmpassword" name="confirmpassword" required >
	  	</div>


		
	  	<button type="submit" class="btn-upper btn btn-primary checkout-page-button" name="change">تغيير </button>
	</form>					
</div>
<!-- Sign-in -->
