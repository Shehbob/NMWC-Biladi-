...
<div class="side-menu animate-dropdown outer-bottom-xs">
    <div class="head"><i class="icon fa fa-align-justify fa-fw"></i>القائمة </div>        
...
<!-- ================================== TOP NAVIGATION : END ================================== -->	            <div class="sidebar-module-container">
	            	<h3 class="section-title">تصفح المزيد </h3>
...
{?>							
			...
			<div class="product-price">	
				<span class="price">
					RY. <?php echo htmlentities($row['productPrice']);?>			</span>
										     <span class="price-before-discount">. <?php echo htmlentities($row['']);?></span>
				...
				<div class="action">
					<ul class="list-unstyled">
						<li class="add-cart-button btn-group">
							...
							<button class="btn btn-primary" type="button">اطلب الان </button></a>
	  ...
	  <?php } } else {?>
		...
		<div class="col-sm-6 col-md-4 wow fadeInUp"> <h3>لم يتم العثور على طلبات </h3>
		</div>
