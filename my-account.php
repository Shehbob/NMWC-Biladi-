...
<div class="form-group">
					    <label class="info-title" for="name">الاسم <span>*</span></label>
						...
						<div class="form-group">
					    <label class="info-title" for="exampleInputEmail1">عنوان البريد الالكتروني  <span>*</span></label>
			 <input type="email" class="form-control unicase-form-control text-input" id="exampleInputEmail1" value="<?php echo $row['email'];?>" readonly>
					  ...
					  <div class="form-group">
					    <label class="info-title" for="Contact No.">رقم الهاتف <span>*</span></label>
					  ...
					  <button type="submit" name="update" class="btn-upper btn btn-primary checkout-page-button">تحديث البيانات</button>
					</form>
					<?php } ?>
				</div>	
...
<div class="form-group">
					    <label class="info-title" for="Current Password">كلمة المرور السابقة <span>*</span></label>
						...
						<div class="form-group">
					    <label class="info-title" for="New Password">كلمة مرور جديدة  <span>*</span></label>
			 <input type="password" class="form-control unicase-form-control text-input" id="newpass" name="newpass">
					  </div>
					  <div class="form-group">
					    <label class="info-title" for="Confirm Password">تأكيد كلمة المرور الجديدة<span>*</span></label>
					    <input type="password" class="form-control unicase-form-control text-input" id="cnfpass" name="cnfpass" required="required" >
					  </div>
					  <button type="submit" name="submit" class="btn-upper btn btn-primary checkout-page-button">تعديل البيانات  </button>
					</form> 
