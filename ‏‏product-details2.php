...
<div class="sidebar-widget outer-bottom-xs wow fadeInUp">
	<h3 class="section-title">القائمة</h3>
...
<div class="sidebar-widget hot-deals wow fadeInUp">
	<h3 class="section-title">حول العرض</h3>
					...
					<div class="products">
						...
						<div class="product-info text-left m-t-20">
							...
							<div class="product-price">	
								<span class="price">
									RY. <?php echo htmlentities($rws['productPrice']);?>.00
								</span>
									
							    <span class="price-before-discount">RY.<?php echo htmlentities($row['productPriceBeforeDiscount']);?></span>					
						...
						<a href="product-details.php?page=product&action=add&id=<?php echo $rws['id']; ?>" class="lnk btn btn-primary">اطلب الان </a>
...
<?php } ?>
							<div class="stock-container info-container m-t-10">
								<div class="row">
									<div class="col-sm-3">
										<div class="stock-box">
											<span class="label">مكان الطلب :</span>
										</div>	
									</div>
									<div class="col-sm-9">
										<div class="stock-box">
...
<div class="stock-container info-container m-t-10">
								<div class="row">
									...
									<div class="col-sm-9">
										<div class="stock-box">
											<span class="value"><?php echo htmlentities($row['']);?></span>
										</div>	
									</div>
								</div><!-- /.row -->	
							</div>
...
<div class="stock-container info-container m-t-10">
							...
							<div class="price-container info-container m-t-20">
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="price-box">
											<span class="price">RY. <?php echo htmlentities($row['productPrice']);?></span>
											<span class="price-strike">RY.<?php echo htmlentities($row['productPriceBeforeDiscount']);?></span>
										</div>
									</div>
							...
							<div class="quantity-container info-container">
								<div class="row">
									...
									<div class="col-sm-7">
										<a href="product-details.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="btn btn-primary"><i class="fa fa-shopping-cart inner-right-vs"></i>احجز الان</a>
									</div>
							...
							<div class="product-social-link m-t-20 text-right">
								<span class="social-label">شارك :</span>
					...
					<div class="row">
						<div class="col-sm-3">
							<ul id="product-tabs" class="nav nav-tabs nav-tab-cell">
								<li class="active"><a data-toggle="tab" href="#description">التفاصيل </a></li>
...
<section class="section featured-product wow fadeInUp">
	<h3 class="section-title">طلبات ذات صلة  </h3>
...
while($rw=mysqli_fetch_array($qry))
{
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="‏‏product-details2.php?pid=<?php echo htmlentities($rw['id']);?>"><img  src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($rw['id']);?>/<?php echo htmlentities($rw['productImage1']);?>" width="150" height="240" alt=""></a>
			</div><!-- /.image -->			
		...
		<div class="product-info text-left">
			<h3 class="name"><a href="‏‏product-details2.php?pid=<?php echo htmlentities($rw['id']);?>"><?php echo htmlentities($rw['productName']);?></a></h3>
			...
			<div class="product-price">	
				...
				<div class="action">
					<ul class="list-unstyled">
						...
						<a href="‏‏product-details2.php?page=product&action=add&id=<?php echo $rw['id']; ?>" class="lnk btn btn-primary">Add to cart</a>
