		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="cart-qty item">العدد</th>
					<th class="cart-sub-total item">سعر كل منتج
</th>
					<th class="cart-total item">المجموع الإجمالي
</th>
					<th class="cart-total item">طريقة الدفع او السداد
</th>
...
<?php $cnt=$cnt+1;} } else { ?>
				<tr><td colspan="8">إما معرف الطلب أو معرف البريد الإلكتروني المسجل غير صالح
</td></tr>
				<?php } ?>
			</tbody><!-- /tbody -->
		</table><!-- /table -->
